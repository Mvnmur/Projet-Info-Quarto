    ...
    class Program
    {
        ...
        public static string choisirPiece(ref string[] Pieces)
        {
            ...
            do
            {
                ...
                pieceChoisie = Console.ReadLine(); //Demande une pièce au joueur
                ...
                if (isin == false) Console.WriteLine("La commande est invalide ou la pièce a déjà été jouée, veuillez recommencer.");
            } while (isin == false);
        ...
        public static bool placerPiece(string piece, ref string[,] Plateau)
        {
            ...
            do
            {
                ...
                if (place == "QUARTO") //On peut entrer QUARTO afin de gagner si la pièce dont on dispose permet de faire un quarto
        ...
        public static bool QuartoJoueur(string piece, string[,] Plateau)
        {
            ...
            switch (Q) //Test sur chaque alignement
            {
                case "1":
        ...
        static void Main(string[] args)
        {
            ...
            string[,] Plateau = new string[4, 4]; //On initialise le plateau
            string regle;
            ...
            else //Si le joueur perd au pile ou face, l'IA commence
            {
                ...
                while (win == false && ntours<9) //La partie dure jusqu'à ce qu'il y ait un quarto ou que le Plateau soit plein
                {
                    ...
                    if (piece == null && win == false) //Si l'IA voit un quarto
                        win = true; //Elle gagne
                    else
                    { 
                        if (win == false)
